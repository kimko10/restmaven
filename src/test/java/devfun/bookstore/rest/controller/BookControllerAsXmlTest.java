...
public class BookControllerAsXmlTest {
	...
	public void testCreateBook() throws Exception {
		String content = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
				+ "<book><id>100</id><title>바라야 내전</title><creator>로이스 맥마스터 부졸드</creator>"
				+ "<type>외국판타지소설</type><date>2011-08-15T12:21:00+09:00></date></book>";
		
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/books").contentType(MediaType.APPLICATION_XML).content(content)
				.accept(MediaType.APPLICATION_XML);
		this.mockMvc.perform(requestBuilder).andDo(print())
	...
	public void testUpdateBook() throws Exception {
		...
		Book updateBook = new Book(3, "어스시의 마법사", "어슐러 K. 르귄",
				"판타지소설", new Date());
		// Java 2 Xml
